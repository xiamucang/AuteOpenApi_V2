...
/**
 * PerfStation entity. @author MyEclipse Persistence Tools
 */

public class PerfStation implements java.io.Serializable {
	...
	/** minimal constructor */
	public PerfStation(String mac, Timestamp collTime) {
		this.mac = mac;
		this.collTime = collTime;
	}

	/** full constructor */
	public PerfStation(String mac, String apMac, String wtpBelongApId,
			String acIp, Timestamp collTime, String staIp, String ssid,
